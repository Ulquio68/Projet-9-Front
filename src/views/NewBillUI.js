            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <p id="wrongFormat">Veuillez n'utiliser uniquement des fichiers au format jpg, jpeg, ou png.</p>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="submitForm" class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
